...
class Packet_metaclass(_Generic_metaclass):
    def __new__(cls,  # type: ignore
        ...
        if "fields_desc" in dct:  # perform resolution of references to other packets  # noqa: E501
            ...
            for uf in current_fld:
                if isinstance(uf, Packet_metaclass):  # reference to another fields_desc  # noqa: E501
                    for f2 in uf.fields_desc:  # type: ignore
                        resolved_fld.append(f2)
                else:
                    resolved_fld.append(uf)
