...
class Conf(ConfClass):
    ...
    protocols = None  # type: 'scapy.dadict.DADict'
    services_udp = None  # type: 'scapy.dadict.DADict'
    services_tcp = None  # type: 'scapy.dadict.DADict'
    services_sctp = None  # type: 'scapy.dadict.DADict'
